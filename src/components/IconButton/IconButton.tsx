...
const iconRenderers = {
  ...
  close: () => (
    <svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
      <line x1="2" y1="2" x2="12" y2="12" style={{ stroke: 'rgb(255,0,0)' }} />
      <line x1="12" y1="2" x2="2" y2="12" style={{ stroke: 'rgb(255,0,0)' }} />
    </svg>
  ),
  openInBrowser: () => (
...
export function IconButton({ className, icon, danger, ...rest }: BaseProps) {
  return (
    <div
