...
function ConnectionIndicator({ className, ...rest }) {
  const multiaddrs = usePort(channels.multiaddrs);

  return (
    <div
      className={classNames(className, 'mx-2')}
      title={multiaddrs ? `Listening on: ${multiaddrs}` : 'Trying to connect to rendezvous server'}
    >
      <svg
